...
public class CurvedMotionFragment extends BaseFragment implements View.OnClickListener {
    ...
    private static volatile CurvedMotionFragment instance;

    public static CurvedMotionFragment getInstance() {
        if (instance == null) {
            synchronized (CurvedMotionFragment.class) {
                if (instance == null) {
                    instance = new CurvedMotionFragment();
                }
            }
        }
        return instance;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_curved_motion, container, false);
        initView(view);
