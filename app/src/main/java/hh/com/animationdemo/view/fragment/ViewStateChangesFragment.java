...
public class ViewStateChangesFragment extends BaseFragment implements View.OnClickListener {
    ...
    private static volatile ViewStateChangesFragment instance;

    public static ViewStateChangesFragment getInstance() {
        if (instance == null) {
            synchronized (ViewStateChangesFragment.class) {
                if (instance == null) {
                    instance = new ViewStateChangesFragment();
                }
            }
        }
        return instance;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_view_state_changes, container, false);
        initView(view);
